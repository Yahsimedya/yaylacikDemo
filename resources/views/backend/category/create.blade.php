    ...
    <fieldset class="mb-3">
       ...
       <!-- <select name="parent_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="text"  name="category_tr" class="form-control">
                @error('category_tr')
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2">Kategori İcon</label>
            <div class="col-lg-10">
                <select class="form-control " name="category_icon" >
                    ...
                    <option value="fa-align-right"><i class="fa-align-right">&#xf038;</i> fa-align-right</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <textarea class="form-control" name="category_keywords" id="" cols="30" rows="10"></textarea>
