                ...
                <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <a href="#"><img class=" img-fluid" src="<?php echo e(asset($websetting->logowhite)); ?>"
                                                 alt=""></a></div></div>

                     <!--  <div class="cizgi mt-2 mb-2" style="width: 100%;height: 1px;background-color:white ; ">

                       </div> -->
                        <form class="search-form mt-3" action="<?php echo e(route('search')); ?>" method="POST" role="search">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php $__currentLoopData = $Fullcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item active position-relative">
                                ...
                                <a class="nav-link " id="#<?php echo e(str_slug($categories->category_tr) .'/'. $categories->id); ?>" href="<?php echo e(URL::to('/category/' . str_slug($categories->category_tr) .'/'. $categories->id)); ?>"><?php echo e($categories->category_tr); ?> <span class="sr-only">(current)</span></a>
                            </li>
...
<a class="navbar-brand p-2" href="<?php echo e(URL::to('/')); ?>"><img class="logo img-fluid" src="<?php echo e(asset($websetting->logo)); ?>"
            ...
            <!-- Arama Butonu Alanı -->
                ...
                <ul class="list-group list-group-horizontal my-auto top-menu" style="font-size: 15px;">
                    <li class="list-group-item font-weight-bold border-0 pr-1 pl-1 w-100 d-block text-center bg-transparent"><?php echo e($gelenil); ?><span class=" pl-2 pr-2 text-center"><?php echo e($veri); ?>&deg;<?php echo $icon; ?></span></li>

                    <li class="list-group-item float-left border-right  pr-1 pl-1 border-0 d-none d-sm-block w-100 bg-transparent text-center"><i class="fa fa-pencil color-fume pr-1"></i><a class="color-fume" href="<?php echo e(route('author')); ?>">Yazarlar</a>
                    </li>
                    <li class="list-group-item float-left border-right  pr-1 pl-1 border-0 w-100 bg-transparent"><i class="fa fa-stethoscope color-fume pr-1"></i><a class="color-fume" href="<?php echo e(route('nobetciEczane')); ?>">Nöbetçi
                            Eczane</a>
                    </li>
                    <li class="list-group-item float-left border-right pr-1 pl-1 border-0 w-100 bg-transparent"><i class="fa fa-briefcase color-fume pr-1"></i><a class="color-fume" href="<?php echo e(route('cenazeilanlari')); ?>">Cenaze
                            İlanları</a>
                    </li>
